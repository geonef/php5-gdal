...
if test "$PHP_GDAL" != "no"; then
  ...
  PHP_NEW_EXTENSION(gdal, php_gdal.cc gdal_main.cc cpl.cc ogr.cc ogrsfdriverregistrar.cc ogrsfdriver.cc ogrdatasource.cc ogrlayer.cc ogrfeaturedefn.cc ogrfielddefn.cc, $ext_shared)
fi
